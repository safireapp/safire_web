export const text = (url: string) => `Welcome to Safire!

Confirm your email address to start.

Confirm Email ( ${url} )

Need more help figuring things out? Email us at

support@fayd.me ( support@fayd.me )

♥ POWERED BY TWILIO SENDGRID ( https://www.sendgrid.com/?utm_source=powered-by&utm_medium=email )`;

export const html = (url: string) => `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><html data-editor-version="2" class="sg-campaigns" xmlns="http://www.w3.org/1999/xhtml"><head>
...
<![endif]-->
  ...
  <![endif]-->
    ...
    <tbody>
      <tr>
        <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
          <img class="max-width" width="150px" border="0" style="display:block; border-radius: 5px; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px;" alt="safire" data-proportionally-constrained="true" data-responsive="false" src="https://cloud-flucj5pff-hack-club-bot.vercel.app/0group_8.png">
        </td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:18px 30px 18px 30px; line-height:40px; text-align:inherit; background-color:#dde6de;" height="100%" valign="top" bgcolor="#dde6de" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="color: #6fab81; font-size: 40px; font-family: inherit">Welcome to Safire!</span></div><div></div></div></td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:18px 50px 18px 50px; line-height:22px; text-align:inherit; background-color:#dde6de;" height="100%" valign="top" bgcolor="#dde6de" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 16px; font-family: inherit">Confirm your email address to start.&nbsp;</span></div><div></div></div></td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:40px 40px 40px 40px; line-height:22px; text-align:inherit; background-color:#fe737c;" height="100%" valign="top" bgcolor="#fe737c" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="color: #ffffff; font-size: 16px">Need more help figuring things out? Email us at</span></div>
<div style="font-family: inherit; text-align: center"><br></div>
<div style="font-family: inherit; text-align: center"><a href="mailto:support@fayd.me"><span style="color: #ffffff; font-size: 16px"><u>support@fayd.me</u></span></a></div><div></div></div></td>
      </tr>
    </tbody>
  </table>
